package com.example.photosortingsystem.view;
 ...
 * 图片缩放视图
 */
public class ZZoomImageView extends androidx.appcompat.widget.AppCompatImageView implements View.OnTouchListener, ScaleGestureDetector.OnScaleGestureListener,
        ViewTreeObserver.OnGlobalLayoutListener {
    //禁止未使用的警告，因为它可能会在稍后的某个时间使用
